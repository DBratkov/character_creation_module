"""This is new fantastic text game."""
...
def special(char_name: str, char_class: str):
    '''Func to generate specail skill.'''
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    '''Func to choice you heroes class.'''
    approve_choice: str = ''
    char_class: str = ''
